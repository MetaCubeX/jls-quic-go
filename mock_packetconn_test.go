...
//
//	mockgen -typed -package quic -self_package github.com/metacubex/jls-quic-go -self_package github.com/metacubex/jls-quic-go -destination mock_packetconn_test.go net PacketConn
//
